...
The project consist to train an agent to navigate and collect as many yellow banana as possible while avoiding blue ones in a square world.  
...
The saved model weights of the successful agent :`checkpoint_nav.pth`   
